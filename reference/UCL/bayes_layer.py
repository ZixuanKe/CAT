...
class BayesianConv1D(_BayesianConvNd):
    def __init__(self, in_channels, out_channels, kernel_size,
                 stride=1, padding=0, dilation=1, groups=1, bias=True, ratio=0.25):
        ...
        padding = padding
        dilation = dilation
        super(BayesianConv1D, self).__init__(in_channels, out_channels, kernel_size,
                                             stride, padding, dilation, False, 0, groups, bias, ratio)
