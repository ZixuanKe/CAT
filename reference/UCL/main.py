...
elif args.approach == 'ewc' or args.approach == 'rwalk' or args.approach == 'mas' or args.approach == 'sgd':
...
if args.output=='':
    args.output='./res/'+args.experiment+'_'+args.approach+'_'+args.note+'.txt'
...
if args.experiment == 'split_cifar100' or args.experiment == 'split_cifar10_100' \
        or args.experiment == 'split_cifar10' or args.experiment == 'split_cifar100_20'\
        or args.experiment == 'cifar10' or args.experiment == 'cifar100' or args.experiment == 'alexmixceleba':
    ...
    if args.approach == 'ucl':
        from networks import kim_net_ucl as network
...
print('args.conv_net: ',args.conv_net)
if args.conv_net == False:
    print('args.approach: ',args.approach)
    if args.approach == 'ucl' or args.approach == 'ucl_ablation':
        net = network.Net(inputsize, taskcla, args.ratio, unitN=args.unitN,  split = split, notMNIST=notMNIST, args=args).cuda()
        net_old = network.Net(inputsize, taskcla, args.ratio, unitN=args.unitN, split = split, notMNIST=notMNIST, args=args).cuda()
    ...
    if args.approach == 'ucl' or args.approach == 'ucl_ablation':
        ...
        if 'sentiment' in args.experiment:
            net = network.Net(inputsize, taskcla, args.ratio,voc_size=voc_size,weights_matrix=weights_matrix).cuda()
            net_old = network.Net(inputsize, taskcla, args.ratio,voc_size=voc_size,weights_matrix=weights_matrix).cuda()
...
with open(performance_output,'w') as file:
    if args.approach == 'hat' or args.approach == 'sgd' or args.approach == 'joint' or args.approach == 'ucl':
        for j in range(acc.shape[1]):
