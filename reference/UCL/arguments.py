...
def get_args():
    ...
    parser.add_argument('--dis_ntasks',default=10,type=int,required=False,help='(default=%(default)d)')
    parser.add_argument('--sim_ntasks',default=10,type=int,required=False,help='(default=%(default)d)')
