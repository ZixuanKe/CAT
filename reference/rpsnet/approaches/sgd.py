...
class Appr(object):
    ...
    def eval(self,t,x,y,args):
        ...
        # if args.experiment=='landmine':
        #     p_class, r_class, f_class, support_micro = \
        #         precision_recall_fscore_support(y_true=targets.data.cpu().numpy(), y_pred=pred.data.cpu().numpy(),
        #                                                labels=[0, 1], average=None)
        #     return total_loss/total_num,np.array(f_class.mean())
        #
        # else:
        #     return total_loss/total_num,total_acc/total_num
