...
def get(seed=0, fixed_order=False, pc_valid=0, args=0):
    ...
    if 'stack' in args.note:
        ...
        for stack_id in range(args.ntasks*2,args.ntasks*3):
            data[stack_id] = data_cifar100[stack_id]
            taskcla.append(taskcla_cifar100[stack_id])

        for stack_id in range(args.ntasks*3,args.ntasks*4):
        ...
        for stack_id in range(args.ntasks*2,args.ntasks*4):
            if (stack_id % 2) == 0: # Even
        ...
        f_name = 'mixall_femnist_fceleba_random_'+str(args.ntasks*4)
        ...
        data_id = 0
        for task_id in range(args.ntasks*4):
        ...
        for task_id in range(args.ntasks*4):
            ...
            elif 'celeba' in random_sep[task_id]:# Even
            ...
            elif 'cifar100' in random_sep[task_id]:# Even
...
def read_emnist(seed=0,fixed_order=False,pc_valid=0,args=0,size=0):
    ...
    print('training len: ',len(data[label//5]['train']['x']))
    print('testing len: ',len(data[label//5]['test']['x']))
