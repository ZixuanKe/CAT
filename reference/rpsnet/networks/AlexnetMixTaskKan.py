...
class Net(torch.nn.Module):
    ...
    def forward(self,t,x,s=1,phase=None,smax=None,args=None,pre_mask=None, from_t=None):
        ...
        if phase == 'ac':
            ...
            y=[]
            for t,i in self.taskcla:
                y.append(self.transfer_layers.transfer[from_t][t](self.mcl.last[from_t](h)))
            return y
