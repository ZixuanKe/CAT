...
from data.my_cifar100_data import CIFAR100Data
...
def load_datasets(config, shared, logger, data_dir='../datasets'):
    ...
    # my data: mixceleba
    data,taskcla,inputsize=mixceleba.get(seed=args.seed,args=args)
    ...
    for t,ncla in taskcla:
        dhandlers.append(CIFAR100Data(use_one_hot=True,data=data[t]))
...
def my_args():
    ...
    parser.add_argument('--note',default='full,random,sep-cifar100',type=str,required=False,help='(default=%(default)d)')
