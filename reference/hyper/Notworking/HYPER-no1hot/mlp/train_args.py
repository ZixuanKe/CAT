...
def parse_cmd_arguments(mode='resnet_cifar', default=False, argv=None):
    ...
    if mode == 'resnet_cifar':
        ...
        dout_dir = './out_resnet/' + config.note
...
def general_options(parser):
    ...
    agroup.add_argument('--ntasks',default=10,type=int,required=False,help='(default=%(default)d)')
    ...
    agroup.add_argument('--pdrop1',default=-1,type=float,required=False,help='(default=%(default)f)')
    agroup.add_argument('--pdrop2',default=-1,type=float,required=False,help='(default=%(default)f)')
