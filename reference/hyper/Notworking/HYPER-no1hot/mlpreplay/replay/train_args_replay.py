...
def collect_rp_cmd_arguments(mode='split', description= "",argv=0):
    ...
    agroup.add_argument('--note',default='small,random,sep-emnist',type=str,required=False,help='(default=%(default)d)')
    ...
    agroup.add_argument('--classptask',default=5,type=int,required=False,help='(default=%(default)d)')
    ...
    agroup.add_argument('--taskcla',default=[],type=list,required=False,help='(default=%(default)f)')
    ...
    if mode == 'split':
        ...
        cl_argroup = cli.cl_args(parser, show_beta=False,
            ...
            show_cl_scenario=True, show_num_tasks=True, dnum_tasks=config.ntasks)
        train_argroup = cli.train_args(parser, show_lr=False, dbatch_size=64,
