...
class CIFAR100Data(Dataset):
    ...
    def _read_batches(self, data):
        ...
        self._data['train_in_data'] = data['train']['x']
        self._data['valid_in_data'] = data['valid']['x']
        self._data['test_in_data'] = data['test']['x']
        ...
        self._data['train_out_data'] = train_labels
        self._data['valid_out_data'] = valid_labels
        self._data['test_out_data'] = test_labels

        self._data['in_data'] = torch.cat([data['train']['x'],data['valid']['x'],data['test']['x']]).cpu().numpy()
        self._data['out_data'] = torch.cat([train_labels,valid_labels,test_labels]).cpu().numpy()


        print("self._data['train_in_data']: ",self._data['train_in_data'].shape)
